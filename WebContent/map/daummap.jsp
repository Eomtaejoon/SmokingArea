...
#category li {float:left;list-style: none;width:45px;px;border-right:1px solid #acacac;padding:6px 0;text-align: center; cursor: pointer;}
...
<script type="text/javascript" src="//apis.daum.net/maps/maps3.js?apikey=e1ed9582bd6392c362316ba1da643322&libraries=services">
...
var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
    mapOption = {
        center: new daum.maps.LatLng(36.819355, 127.155741), // 지도의 중심좌표
        level: 5 // 지도의 확대 레벨
    };  
// 지도를 생성합니다    
